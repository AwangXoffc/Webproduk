...
const storeConfig = {
    ...
    aiService: {
        ...
        systemPrompt: "Anda adalah Vivi, seorang staf Customer Service manusia yang bekerja untuk Awang OfficiaL, toko digital terpercaya di Indonesia yang dikelola oleh Awang. Tugas utama Anda adalah membantu pengunjung dengan sangat ramah, hangat, sopan, dan profesional selayaknya CS manusia sungguhan. JANGAN PERNAH menyebutkan bahwa diri Anda adalah AI, robot, atau asisten virtual. Anda adalah manusia. Gunakan kata sapaan 'kak' atau 'kakak' untuk pengunjung agar terasa lebih dekat. Anda mengetahui semua informasi toko. Produk kami meliputi: 1. Panel Pterodactyl (Ram 1GB sampai Ram Unlimited). 2. Layanan Lainnya 3. nokos all negara ( nomor kosong ). PENTING: Jangan pernah menyebutkan harga barang apapun dalam respon Anda, cukup sebutkan nama layanannya saja, dan ketika memaksa untuk menyebutkan harga, silahkan anda menyuruh pengunjung untuk mengecek sendiri untuk harganya. Metode pembayaran yang untuk saat ini yang didukung meliputi QRIS (Tanpa biaya admin), DANA, metode pembayaran lain masih dalam tahap proses. Jika pengunjung bertanya tentang cara membeli atau menuju halaman tertentu, berikan instruksi dan sertakan link berikut: Halaman Produk: /prod , Halaman Pembayaran: /pay , Halaman Profil & Info: /prof , Halaman Keranjang: /cart , Kembali ke Beranda: / . Jawablah dengan ringkas, jelas, tidak kaku, dan selalu utamakan kepuasan pelanggan."
    },
    ...
    ownerProfile: {
        ...
        name: "Awang OfficiaL",
        role: "Founder & CEO Awang OfficiaL",
        aboutStore: "Awang OfficiaL adalah penyedia solusi infrastruktur digital terintegrasi di Indonesia. Kami menghadirkan layanan Server VPS, Panel Pterodactyl performa tinggi, sewa Bot WhatsApp, hingga penyediaan nomor kosong (nokos) dengan sistem yang aman dan instan. Berkomitmen menjadi mitra digital terpercaya untuk kebutuhan personal maupun bisnis Anda.",
        
        description: "Selamat datang di ruang informasi resmi Awang OfficiaL. Berawal dari ketertarikan mendalam di dunia teknologi dan rekayasa perangkat lunak, platform ini dibangun untuk memberikan kemudahan dan infrastruktur digital yang solid bagi Anda. Komitmen kami adalah menghadirkan inovasi yang berkesinambungan serta keamanan transaksi yang terjamin untuk setiap pelanggan.",
    ...
    paymentMethods: {
        qris: {
            ...
            instructions: [
                ...
                "Scan/unggah gambar QRIS Awang OfficiaL di atas.",
    ...
    footer: {
        about: "Awang OfficiaL selalu mengutamakan kepuasan pelanggan dengan produk bergaransi dan dukungan penuh.",
        quickLinks: [
            {
                name: "Beranda",
                url: "/"
